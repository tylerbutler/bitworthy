...
using TylerButler.Kingsburg.Windows;
#endregion
...
namespace Marblets
{
    ...
    public static class Sound
    {
        ...
        {
            //engine = new AudioEngine( KingsburgWindowsGame.Settings.MediaPath +
            //                         @"audio\marblets.xgs" );
            //wavebank = new WaveBank( engine, KingsburgWindowsGame.Settings.MediaPath +
            //                                @"audio\marblets.xwb" );
            //soundbank = new SoundBank( engine, KingsburgWindowsGame.Settings.MediaPath +
            //                                  @"audio\marblets.xsb" );
