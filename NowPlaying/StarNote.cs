...
public class StarNote : System.Windows.Forms.Form
{
	...
	public StarNote( string textIn, string type, double maxTransparency, int notificationTime )
	{
		...
		timerTime = notificationTime;
		

		switch( type )
		{
			case "update":
				stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("NowPlaying.images.update.png");
				break;
			case "mail":
				stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("NowPlaying.images.mail.png");
				break;
			case "agent":
				stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("NowPlaying.images.agent.png");
				break;
			default:
				stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("NowPlaying.images.star.png");
				break;
		}
